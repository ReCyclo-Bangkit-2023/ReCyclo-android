...
import com.zeroone.recyclo.ui.dashboard.waste.edit.EditActivity
import com.zeroone.recyclo.utils.LoadingBar
import com.zeroone.recyclo.utils.Utils


class WasteAdapter(private val vm : WasteViewModel, private val lifecycleOwner: LifecycleOwner, private val listGoods: ArrayList<DataItem>) : RecyclerView.Adapter<WasteAdapter.ListViewHolder>() {
